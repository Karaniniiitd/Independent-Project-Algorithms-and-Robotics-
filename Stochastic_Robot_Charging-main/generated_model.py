...
for t in range(T):
 opt.add(Sum([If(assign_0_0[t],1,0),If(assign_0_1[t],1,0)])<=1)
 opt.add(Sum([If(assign_1_0[t],1,0),If(assign_1_1[t],1,0)])<=1)
 opt.add(Sum([If(assign_2_0[t],1,0),If(assign_2_1[t],1,0)])<=1)
 opt.add(Sum([If(assign_3_0[t],1,0),If(assign_3_1[t],1,0)])<=1)
 opt.add(Sum([If(assign_0_0[t],1,0),If(assign_1_0[t],1,0),If(assign_2_0[t],1,0),If(assign_3_0[t],1,0)])<=1)
 opt.add(Sum([If(assign_0_1[t],1,0),If(assign_1_1[t],1,0),If(assign_2_1[t],1,0),If(assign_3_1[t],1,0)])<=1)
